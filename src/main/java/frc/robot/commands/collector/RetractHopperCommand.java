...
public class RetractHopperCommand extends Command {
  ...
  public RetractHopperCommand(CollectorSubsystem collector) {
    this(collector, 0.05); // Default tolerance of 0.01 rotations
  }

  public RetractHopperCommand(CollectorSubsystem collector, double tolerance) {
