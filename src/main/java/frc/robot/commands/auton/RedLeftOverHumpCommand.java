...
/**
 * Red alliance LEFT collect-and-shoot autonomous — OVER HUMP variant.
 * Mirror of Red Right - waypoints reflected across field centerline (Y = 4.115m)
 * Returns over the hump both times instead of going under the trench.
 */
public class RedLeftOverHumpCommand extends Command {
  ...
  private static final Translation2d COLLECT_ALIGN_POS    = new Translation2d(9.4,   1.73);  // was 6.5
  private static final Translation2d COLLECT_POS          = new Translation2d(8.8,   2.73);  // was 5.5
  private static final Translation2d SWEEP_MID_POS        = new Translation2d(9.5,   3.73);  // was 4.5
  private static final Translation2d PRE_HUMP_POS         = new Translation2d(10.3,  2.53);  // was 5.7
  private static final Translation2d SHOOT_POS            = new Translation2d(14.2,  2.63);  // was 5.6

  // Second cycle waypoints (mirrored)
  private static final Translation2d COLLECT_ALIGN_POS_2  = new Translation2d(8.7,   3.08);  // was 5.15
  private static final Translation2d INTERMEDIATE_POS_2   = new Translation2d(8.8,   4.33);  // was 3.9
  private static final Translation2d COLLECT_POS_2        = new Translation2d(10.0,  4.33);  // was 3.9
  private static final Translation2d SWEEP_MID_POS_2      = new Translation2d(10.6,  3.53);  // was 4.7
  private static final Translation2d PRE_HUMP_POS_2       = new Translation2d(10.6,  2.63);  // was 5.6
  ...
  public void execute() {
    ...
    switch (m_phase) {
      ...
      case DRIVE_TO_COLLECT_ALIGN:
        driveToWaypointSmooth(pose, COLLECT_ALIGN_POS, COLLECT_POS, 135.0, Phase.DRIVE_COLLECT);  // mirrored heading
        break;

      case DRIVE_COLLECT:
        driveToWaypointSmooth(pose, COLLECT_POS, SWEEP_MID_POS, 90.0, Phase.DRIVE_SWEEP_MID);  // mirrored heading
        break;

      case DRIVE_SWEEP_MID:
        driveToWaypoint(pose, SWEEP_MID_POS, 45.0, Phase.DRIVE_PRE_HUMP);  // mirrored heading
        break;

      case DRIVE_PRE_HUMP:
        driveToWaypoint(pose, PRE_HUMP_POS, -45.0, Phase.DRIVE_OVER_HUMP);  // mirrored heading
        break;

      case DRIVE_OVER_HUMP:
        driveOverHump(pose, SHOOT_POS, -45.0, Phase.VISION_SETTLE);  // mirrored heading
      ...
      case DRIVE_BACK_TO_COLLECT:
        m_collector.extendHopper();  // Deploy hopper while driving
        driveToWaypointSmooth(pose, COLLECT_ALIGN_POS_2, INTERMEDIATE_POS_2, 120.0, Phase.DRIVE_INTERMEDIATE_2);  // mirrored heading
        break;

      case DRIVE_INTERMEDIATE_2:
        driveToWaypointSmooth(pose, INTERMEDIATE_POS_2, COLLECT_POS_2, 45.0, Phase.DRIVE_COLLECT_2);  // mirrored heading
        break;

      case DRIVE_COLLECT_2:
        driveToWaypointSmooth(pose, COLLECT_POS_2, SWEEP_MID_POS_2, -40.0, Phase.DRIVE_SWEEP_MID_2);  // mirrored heading
        break;

      case DRIVE_SWEEP_MID_2:
        driveToWaypoint(pose, SWEEP_MID_POS_2, -90.0, Phase.DRIVE_PRE_HUMP_2);  // mirrored heading
        break;

      case DRIVE_PRE_HUMP_2:
        driveToWaypoint(pose, PRE_HUMP_POS_2, -45.0, Phase.DRIVE_OVER_HUMP_2);  // mirrored heading
        break;

      case DRIVE_OVER_HUMP_2:
        driveOverHump(pose, SHOOT_POS, -45.0, Phase.VISION_SETTLE_2);  // mirrored heading
