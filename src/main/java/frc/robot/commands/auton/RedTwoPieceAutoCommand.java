...
/**
 * Two-piece autonomous: shoot at start, drive to pickup, wait, drive to second
 * shoot position, aim and shoot again.
 *
 * Sequence:
 * 1. Aim at speaker and shoot (from start pose ~13.02, 5.55)
 * 2. Deploy hopper + drive to pickup position (16.064, 7.432)
 * 3. Wait 3 seconds at pickup (collector running)
 * 4. Drive to second shoot position (14.10, 5.79), pre-spin shooter
 * 5. Aim and shoot; 2s after indexers start, set hopper to 0.07
 */
public class RedTwoPieceAutoCommand extends Command {
