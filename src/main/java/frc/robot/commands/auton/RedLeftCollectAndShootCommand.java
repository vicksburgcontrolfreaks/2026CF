...
/**
 * Red alliance LEFT collect-and-shoot autonomous (lower field, y near 0.46).
 *
 * Sequence:
 *  1. Drive to (10.70, 0.46) @ 180° — through trench; deploy hopper, start collector
 *  2. Drive to (8.77,  2.05) @ 90°  — collector running
 *  3. Drive to (8.77,  3.53) @ 90°  — collect phase; stop collector on arrival
 *  4. Drive to (10.70, 0.46) @ 0°   — back through trench
 *  5. Drive to (12.91, 0.46) @ 0°   — clear trench
 *  6. Drive to (13.23, 2.37) @ -60° — shoot position
 *  7. Aim and shoot (4 sec)
 *  8. Drive to (12.91, 0.46) @ 180° — back to trench entrance
 *  9. Drive to (10.70, 0.46) @ 180° — through trench; deploy hopper, start collector again
 * 10. Drive to (8.77,  2.05) @ 90°
 * 11. Drive to (8.77,  3.53) @ 90°  — collect; stop collector on arrival
 * 12. Drive to (10.70, 0.46) @ 0°
 * 13. Drive to (12.91, 0.46) @ 0°
 * 14. Drive to (13.23, 2.37) @ -60°
 * 15. Aim and shoot again (4 sec)
 */
public class RedLeftCollectAndShootCommand extends Command {
  ...
  private static final Translation2d TRENCH_FAR_POS    = new Translation2d(10.70, 0.46);
  private static final Translation2d COLLECT_ALIGN_POS = new Translation2d(8.77,  2.05);
  private static final Translation2d COLLECT_POS       = new Translation2d(8.77,  3.53);
  private static final Translation2d TRENCH_CLEAR_POS  = new Translation2d(12.91, 0.46);
  private static final Translation2d SHOOT_POS         = new Translation2d(13.23, 2.37);
  ...
  public RedLeftCollectAndShootCommand(DriveSubsystem drive, ShooterSubsystem shooter,
  ...
  public void execute() {
    ...
    switch (m_phase) {
      ...
      case DRIVE_THROUGH_TRENCH_1:
        driveToWaypoint(pose, TRENCH_FAR_POS, 180.0, Phase.DRIVE_TO_COLLECT_ALIGN_1);
      ...
      case DRIVE_BACK_THROUGH_TRENCH_1:
        driveToWaypoint(pose, TRENCH_FAR_POS, 0.0, Phase.DRIVE_CLEAR_TRENCH_1);
        break;

      case DRIVE_CLEAR_TRENCH_1:
        driveToWaypoint(pose, TRENCH_CLEAR_POS, 0.0, Phase.DRIVE_TO_SHOOT_1);
        break;

      case DRIVE_TO_SHOOT_1:
        driveToWaypoint(pose, SHOOT_POS, -60.0, Phase.SHOOT_1);
        break;
      ...
      case DRIVE_TO_TRENCH_ENTRANCE:
        driveToWaypoint(pose, TRENCH_CLEAR_POS, 180.0, Phase.DRIVE_THROUGH_TRENCH_2);
        break;

      case DRIVE_THROUGH_TRENCH_2:
        driveToWaypoint(pose, TRENCH_FAR_POS, 180.0, Phase.DRIVE_TO_COLLECT_ALIGN_2);
      ...
      case DRIVE_BACK_THROUGH_TRENCH_2:
        driveToWaypoint(pose, TRENCH_FAR_POS, 0.0, Phase.DRIVE_CLEAR_TRENCH_2);
        break;

      case DRIVE_CLEAR_TRENCH_2:
        driveToWaypoint(pose, TRENCH_CLEAR_POS, 0.0, Phase.DRIVE_TO_SHOOT_2);
        break;

      case DRIVE_TO_SHOOT_2:
        driveToWaypoint(pose, SHOOT_POS, -60.0, Phase.SHOOT_2);
        break;
