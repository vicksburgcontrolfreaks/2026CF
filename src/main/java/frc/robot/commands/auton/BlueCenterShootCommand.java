...
/**
 * Blue alliance CENTER autonomous. Starts at ~4.45, 4.00 facing 180°.
 * Drives 1 meter toward blue wall to ~2.63, 4.00, then aims and shoots preloaded balls.
 */
public class BlueCenterShootCommand extends Command {
  ...
  private static final Translation2d SHOOT_POS = new Translation2d(2.63, 4.00);
