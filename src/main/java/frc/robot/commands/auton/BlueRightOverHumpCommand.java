...
/**
 * Blue alliance RIGHT collect-and-shoot autonomous — OVER HUMP variant.
 * Mirror of Red Left - waypoints reflected across field length (X = 8.23m)
 * Returns over the hump both times instead of going under the trench.
 */
public class BlueRightOverHumpCommand extends Command {
  ...
  private static final Translation2d COLLECTOR_DEPLOY_POS = new Translation2d(5.77,  0.73);  // was (10.69, 0.73)
  private static final Translation2d COLLECT_ALIGN_POS    = new Translation2d(7.06,  1.73);  // was (9.4, 1.73)
  private static final Translation2d COLLECT_POS          = new Translation2d(7.66,  2.73);  // was (8.8, 2.73)
  private static final Translation2d SWEEP_MID_POS        = new Translation2d(6.96,  3.73);  // was (9.5, 3.73)
  private static final Translation2d PRE_HUMP_POS         = new Translation2d(6.16,  2.53);  // was (10.3, 2.53)
  private static final Translation2d SHOOT_POS            = new Translation2d(2.26,  2.63);  // was (14.2, 2.63)

  // Second cycle waypoints (mirrored)
  private static final Translation2d COLLECT_ALIGN_POS_2  = new Translation2d(7.76,  3.08);  // was (8.7, 3.08)
  private static final Translation2d INTERMEDIATE_POS_2   = new Translation2d(7.66,  4.33);  // was (8.8, 4.33)
  private static final Translation2d COLLECT_POS_2        = new Translation2d(6.46,  4.33);  // was (10.0, 4.33)
  private static final Translation2d SWEEP_MID_POS_2      = new Translation2d(5.86,  3.53);  // was (10.6, 3.53)
  private static final Translation2d PRE_HUMP_POS_2       = new Translation2d(5.86,  2.63);  // was (10.6, 2.63)
  ...
  public BlueRightOverHumpCommand(DriveSubsystem drive, ShooterSubsystem shooter,
